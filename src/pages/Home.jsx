...
const Home = () => {
  return (
    <div>
      <Header />
      <section className="bg-primary text-white body-font min-h-screen">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mt-[-100px] mb-4 font-medium text-white">Hi, USER</h1>
            <h1 className="title-font sm:text-4xl text-3xl mt-40 mb-4 font-medium text-white">PLASTIC WASTE
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img className="object-cover object-center rounded-xl" alt="hero" src="/images/hero-image.jpg" />
          </div>
        </div>
      </section>
    </div>
